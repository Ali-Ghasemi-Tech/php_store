...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="./category_panel.php">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form enctype="multipart/form-data" id="saveform" action="../db/store.php" method="post">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" form="saveform" name="submit">Save
                          changes</button>
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                     ...
                     if(isset($_POST['search_submit'])){
                      $search = $_POST['search'];
                      $db = "categories";
                      $filter_query = "SELECT * FROM categories WHERE title LIKE '%".$search ."%'";
                      $search_result = search( $conn, $filter_query);
                    }
                     ...
                     if($result->num_rows > 0){
                      while($row = $result->fetch_assoc()){
                        ...
                        <td>".$id. "</td>
                        <td> ".$title. "</td>
                        <td><image style='width: auto; height: 50px;' src='$image'></td>
                        <td>
                          <button type='button' class='btn btn-primary' onclick='openEditModal($id, \"$title\" , \"$image\")'>Edit</button>
                        <a href='../db/delete.php?id=".$id."'>Delete</a>
                        </td>
                        </tr>";
          }
          }
                ...
                <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel"
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form enctype="multipart/form-data" id="editForm" action="../db/edit.php?id=<?php echo $id; ?>" method="post">
